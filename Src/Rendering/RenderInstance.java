...
public class RenderInstance {
    ...
    private TextureResource texture = null;
    private Vector4f uv = new Vector4f(0.0f, 0.0f, 1.0f, 1.0f);
    private Vector3f color = new Vector3f(1.0f);

    public RenderInstance(QuadMeshResource _resource, ShaderProgram _shaderProgram) {
        resource = _resource;
    ...
    public void setTextureResource(TextureResource _textureResource) { texture = _textureResource; }
    public TextureResource getTextureResource() { return texture; }
