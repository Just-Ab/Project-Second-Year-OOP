...
public class TestSprite2DInh extends Sprite2D {
    ...
    AnimatedSprite2D as = new AnimatedSprite2D("name");
    ...
    public void _ready(){
        ...
        addChild(rect);
        as.setLocalPosition(new Vector3f(0.0f,0.0f,0.0f));
        as.setTexture("Assets/Textures/anim.png");
        as.setFrameColumns(8);
        as.setFrameRows(9);
        as.setStartingFrame(8*5);
        as.setEndeingFrame(8*6-1);
        as.setNextFrameTime(0.1f);
        rigidbody.addChild(as);
    }
